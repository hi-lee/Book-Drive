	...
	<div id="divContents">
		...
		<div id="divLocation">
			<ul>
				...
				<li><a href="https://cham.kiu.ac.kr/bbs/list/2?pn=1#">공지사항</a></li>
			</ul>
		</div>
		<!-- sns share기능 사용여부 -->
		...
		<div id="divContent">
			...
			<div class="searchArea">
				...
				<form name="searchFrm" id="searchFrm" method="get" action="noticeBoard.bo">
					<fieldset>
						<legend>검색</legend>
						<span class="bunch">
								...
								<c:when test="${!empty boardList}">
									<c:forEach var="list" items="${boardList}" varStatus="status">
										<tr>
											...
											<a href="noticeboardDetail.bo?boardNum=${list.boardNum}&page=${pageinfo.page}">
												${list.boardSubject}
											</a>
											</td>
