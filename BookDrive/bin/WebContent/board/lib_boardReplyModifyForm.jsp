	...
	<div id="divContents_write">
		...
		<div id="divLocation">
			<ul>
				...
				<li><a>QnA 리스트</a></li><li><a href="javascript:void();">QnA 답글수정</a></li>
			</ul>
		</div>
		<form name="f" enctype="multipart/form-data" action="BoardReplyModifyPro.boardL" method="post">
			...
			<input type="hidden" id="p_boardnum" name="p_boardnum" value="${param.p_boardnum}">
