	...
	<div id="divContents">
		...
		<div id="divLocation">
			<ul>
				...
				<li><a>게시판</a></li>
				<li><a href="wishBoard.bo">도서이용신청 리스트</a></li>
			</ul>
		</div>
		<!-- sns share기능 사용여부 -->
		...
		<div id="divContent">
			...
			<div class="searchArea">
				...
				<form name="searchFrm" id="searchFrm" method="get" action="wishBoard.bo">
					<fieldset>
						<legend>검색</legend>
						<span class="bunch">
									...
									<c:forEach var="list" items="${boardList}" varStatus="status">
										<c:if test="${list.memIndex eq sessionScope.userIndex}">
											...
											<tr>
												...
												<a href="wishboardDetail.bo?boardNum=${list.boardNum}&page=${pageinfo.page}">
													${list.boardSubject}
												</a>
												</td>
