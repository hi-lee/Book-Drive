	...
	<div id="divContents">
		...
		<div id="divLocation">
			<ul>
				...
				<li><a>도서관리스트</a></li><li><a href="https://cham.kiu.ac.kr/bbs/list/1#">도서관 상세정보</a></li>
			</ul>
		</div>
							...
							<c:forEach var="list" items="${libAdminList}">
								<tr>
									...
									<td class="libhomepage footable-last-column">
										<a class="btn bg_red c_fff" href="LibraryApvRvoPro.lib?adminNum=${list.adminNum}&adminId=${list.adminId}">승인취소</a>
									</td>
								</tr>
							</c:forEach>
						</c:when>
