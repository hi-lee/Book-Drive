...
<%
	...
	String pageIn = request.getAttribute("pagefile") != null ? (String) request.getAttribute("pagefile") : "/member/admin_loginForm.jsp";
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<c:choose>
		<c:when test="${pagefile eq '/member/admin_main.jsp'}">
...
<div id="divWrapper">
	<jsp:include page="/bdstyle/admin/include/admin_menu_top.jsp"/>
	<hr>
