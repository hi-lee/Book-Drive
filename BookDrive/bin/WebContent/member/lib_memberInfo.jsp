...
<!-- [통합관리자] 도서관 관리자 정보를 출력하는 페이지 -->
<div id="divContentsW">
	<div id="divContents">
		<h2 id="divTitle">도서관관리자 정보</h2>
		<div id="divLocation">
			<ul>
				<li><a href="Adminmain.logL" title="HOME"><img src="bdstyle/admin/image/ko/local/home.png" alt="HOME"></a></li>
				<li><a href="javascript:void();">회원정보</a></li><li><a href="javascript:void();">일반회원 정보</a></li>
			</ul>
		</div>
		<h2 style="margin: 28px 0 14px 0;color:#4b4b4b;font-size:16px;font-weight:600;">관리자정보</h2>
		...
		<div class="buttons">
			<a href="LibAdminModifyForm.libL?index=${admin.adminNum}&id=${admin.adminName}">정보수정</a>
		</div>
	</div>
</div>
