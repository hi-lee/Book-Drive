...
<div class="loginW">
			<form id="login" name="login" action="Adminlogin.logC" method="post">
			<fieldset>
			<legend>로그인</legend>
			<div class="loginContent">
				<div class="intro">
					<img src="bdstyle/admin/image/ko/local/loginIco.png" alt="MEMBER LOGIN">
					<p class="welcome"><strong>BookDrive <span>통합 관리자</span>로</strong> 로그인 해주세요.</p>
				</div>
				<dl>
