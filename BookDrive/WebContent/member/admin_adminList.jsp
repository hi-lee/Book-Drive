...
<!-- [통합관리자] 통합 관리자 목록을 출력하는 페이지 -->
<div id="divContentsW">
   <div id="divContents">
<h2 id="divTitle">통합 관리자 목록</h2>
<div id="divLocation">
	<ul>
		<li><a href="Adminmain.logC" title="HOME"><img src="bdstyle/admin/image/ko/local/home.png" alt="HOME"></a></li>
		<li><a>회원관리</a></li><li><a href="javascript:void();">통합 관리자 리스트</a></li>
	</ul>
</div>
<div id="divContent">
	<!-- Content Header -->
	...
	<div class="listTable">
		<table class="mobileTable default">
			...
			<thead>
				<tr>
					<th scope="row" class="footable-first-column">관리자번호</th>
					<th scope="row">아이디</th>
					<th scope="row">성명</th>
					<th scope="row">연락처</th>
					<th scope="row" class="footable-last-column" data-hide="phone">이메일주소</th>
				</tr>
			</thead>
			<tbody>
				<!-- 관리자 리스트 출력 -->
