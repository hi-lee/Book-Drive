...
import book.svc.lib.BookModifyStateService;
...
public class BookModifyStateAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		String flag = request.getParameter("flag") != null ? request.getParameter("flag") : "bookName";
		...
		if (!updateCheck) {
			...
			forward.setPath("BookList.bookL?flag=" + flag + "&libcode=" + libCode + "&bookstate=" + bookState + "&keyword=" + keyword);
		}
		return forward;
	}
