...
public class BoardWishListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (session.getAttribute("userID") == null || memIndex.equals("")) {
			...
			request.setAttribute("pageIn", "/board/boardWishList.jsp?page="+page+"&kind="+kind+"&keyword="+keyword+"&os="+os+"&limit="+limit);
