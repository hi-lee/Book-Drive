...
public class BoardDAO {
	...
	public int selectBoardListCount(String kind, String keyword, String flag, String libCode) { //게시판 카운트
		// TODO Auto-generated method stub
		int listCount = 0;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		...
		if (!libCode.equals("")) query += " and libCode = '" + libCode + "'";
	...
	public ArrayList<BoardBean> getBoardList(int nowPage, int limit, String kind, String keyword, String flag, String os, String libCode) {
		// TODO Auto-generated method stub
		PreparedStatement pstmt = null;
		ResultSet rs = null;
